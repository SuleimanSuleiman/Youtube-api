...
router.get("/logout", passport.authenticate("jwt"), UserConroller.logout);
router.post("/signup", UserConroller.CreateUser);
router.post("/login", UserConroller.login);
router.get("/sub/:id", passport.authenticate("jwt"), UserConroller.subscribers);
router.get("/unsub/:id", passport.authenticate("jwt"), UserConroller.unsubscribers);
