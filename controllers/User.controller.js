...
module.exports.login = async (req, res, next) => {
    try {
        const theUser = await User.loginUser(req.body.email, req.body.password, next)
...
module.exports.changePassword = async (req, res, next) => {
    try {
        ...
        const verifyPassword = await bcrypt.compare(TheInput.Last, req.user.password)
